<template>
  <div class="assets-manager">
    ...
    <v-tabs-window v-model="activeTab" class="mt-4">
      ...
      <v-tabs-window-item value="backgrounds">
          ...
          <v-card outlined class="mb-4">
            ...
            <v-card-text>
              <v-file-input v-model="newBackgroundFile" accept="image/*" label="Select Background Image"
                ...
                density="compact" show-size prepend-icon="mdi-image-plus" />
          ...
          <div v-else class="assets-grid">
            <v-card v-for="bg in backgrounds" :key="bg.id" outlined class="asset-card">
              ...
              <v-card-actions>
                ...
                <v-spacer />
                <v-btn icon="mdi-delete" size="small" color="error" @click="deleteBackground(bg.id)" />
              </v-card-actions>
            </v-card>
          </div>
        </div>
      ...
      <!-- Avatars Management -->
      <v-tabs-window-item value="avatars">
        <div class="management-section">
          ...
          <v-card outlined class="mb-4">
            ...
            <v-card-text>
              <v-file-input v-model="newAvatarFile" accept="image/*" label="Select Avatar Image"
                hint="Mini avatar will be auto-cropped from the head area" persistent-hint outlined density="compact" show-size
          ...
          <div v-else class="assets-grid">
            <v-card v-for="avatar in avatars" :key="avatar.id" outlined class="asset-card">
              ...
              <v-card-actions>
                ...
                <v-spacer />
                <v-btn icon="mdi-delete" size="small" color="error" @click="deleteAvatar(avatar.id)" />
              </v-card-actions>
            </v-card>
          </div>
        </div>
